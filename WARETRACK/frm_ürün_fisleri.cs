    ...
    public partial class frm_urun_fisleri : Form
    {
        ...
        private void btn_sil_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.pRFICHETableAdapter.Fill(this.wARETRACKDataSet3.PRFICHE);
                txt_urun_kodu.Text = "";
                txt_adet.Text = "";
        ...
        {
            // TODO: This line of code loads data into the 'wARETRACKDataSet3.PRFICHE' table. You can move, or remove it, as needed.
            this.pRFICHETableAdapter.Fill(this.wARETRACKDataSet3.PRFICHE);
