    ...
    public partial class frm_satış_irsaliyeleri : Form
    {
        ...
        private void btn_kaydet_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.tALLYOUTTableAdapter.Fill(this.wARETRACKDataSet2.TALLYOUT);
                txt_urun_kodu.Text = "";
                txt_adet.Text = "";
        ...
        {
            // TODO: This line of code loads data into the 'wARETRACKDataSet2.TALLYOUT' table. You can move, or remove it, as needed.
            this.tALLYOUTTableAdapter.Fill(this.wARETRACKDataSet2.TALLYOUT);
